# =========================================================================
# twr-03 — MikroTik CHR (RouterOS v7)
# Role: Tower / Edge VTEP (Legacy MCLAG)
# Router ID: 100.127.50.103
# AS: 4208675309
# =========================================================================
...
add bridge=br-router bridge-pvid=1104 learning=no \
    local-address=100.127.50.103 \
    mac-address=8E:9A:2E:06:F9:A6 \
    name=vxlan-1104-ipv4-twr-03 vni=1104
add bridge=br-router bridge-pvid=1106 learning=no \
    local-address=3fff:1ab:d127:d50::103 \
    mac-address=BA:73:44:4C:51:5D \
    name=vxlan-1106-ipv6-twr-03 vni=1106 vteps-ip-version=ipv6
...
add afi=ip,ipv6 areas=49.0051 \
    name=ipvx-isis-1 system-id=1001.2705.0103
