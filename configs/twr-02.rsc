# =========================================================================
# twr-02 — MikroTik CHR (RouterOS v7)
# Role: Tower / Edge VTEP
# Router ID: 100.127.50.102
# AS: 4208675309
# =========================================================================
...
add bridge=br-router bridge-pvid=1104 learning=no \
    local-address=100.127.50.102 \
    mac-address=EA:DC:97:20:66:1D \
    name=vxlan-1104-ipv4-twr-02 vni=1104
add bridge=br-router bridge-pvid=1106 learning=no \
    local-address=3fff:1ab:d127:d50::102 \
    mac-address=12:37:A4:64:42:DD \
    name=vxlan-1106-ipv6-twr-02 vni=1106 vteps-ip-version=ipv6
...
add afi=ip,ipv6 areas=49.0051 l2.originate-default=never \
    name=ipvx-isis-1 system-id=1001.2705.0102
