# 2026-03-24 20:34:08 by RouterOS 7.20.8
# system id = f7btFDncbgE
#
/interface bridge
...
/interface vxlan
add bridge=br-router bridge-pvid=1104 learning=no local-address=100.127.50.103 mac-address=8E:9A:2E:06:F9:A6 name=vxlan-1104-ipv4-twr-03 vni=1104
add bridge=br-router bridge-pvid=1106 learning=no local-address=3fff:1ab:d127:d50::103 mac-address=BA:73:44:4C:51:5D name=vxlan-1106-ipv6-twr-03 vni=1106 vteps-ip-version=ipv6
/interface vlan
...
/ipv6 address
add address=fd00:b00b:0:1::f interface=ether1
add address=3fff:1ab:d127:d50::103/128 advertise=no interface=lo.6
add address=3fff:1ab:d50:d24::26 advertise=no interface=ether3
add address=3fff:1ab:d50:d8::10 advertise=no interface=ether2
/routing bgp connection
add afi=ip,evpn disabled=no instance=bgp-instance-as4208675309-01 local.address=100.127.50.103 .role=ibgp name=bgp-peer-ipv4-core-01 remote.address=100.127.1.1 .as=4208675309 templates=bgp-tmplt-ipv4-as4208675309
add afi=ipv6,evpn disabled=no instance=bgp-instance-as4208675309-01 local.address=3fff:1ab:d127:d50::103 .role=ibgp name=bgp-peer-ipv6-core-01 remote.address=3fff:1ab:d127:d1::1 .as=4208675309 templates=bgp-tmplt-ipv6-as4208675309
/routing bgp evpn
